...
do {
    Write-Header
    Write-Host "1. Show-SystemInfo" -ForegroundColor Purple
    Write-Host "2. Rename-Computer" -ForegroundColor Purple
    Write-Host "3. Disable-Indexing" -ForegroundColor Purple
    Write-Host "4. Power-Management" -ForegroundColor Purple
    Write-Host "5. Configure-Network" -ForegroundColor Purple
    Write-Host "6. Set-Date/Time" -ForegroundColor Purple
    Write-Host "7. Join-Domain" -ForegroundColor Purple
    Write-Host "8. Install-Winget" -ForegroundColor Purple
    Write-Host "9. Install-Apps" -ForegroundColor Purple
    Write-Host "10. Activation" -ForegroundColor Purple
    Write-Host "11. Windows-Updates" -ForegroundColor Purple
    Write-Host "12. System-Cleanup" -ForegroundColor Purple
    Write-Host "13. Restart-Computer" -ForegroundColor Purple
    Write-Host "0. Exit" -ForegroundColor Purple
    Write-Host ""
