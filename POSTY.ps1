...
function Install-PCWinget {
    ...
    Write-Header
    Write-Host "WinGet Install / Repair - Windows 10" -ForegroundColor Yellow
    Write-Host ""
    ...
    try {
        ...
        Write-Host "Preparing PowerShell Gallery..." -ForegroundColor Cyan
        ...
        Write-Host "Loading Microsoft WinGet Client..." -ForegroundColor Cyan
